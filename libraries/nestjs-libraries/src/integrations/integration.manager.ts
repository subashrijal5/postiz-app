...
export class IntegrationManager {
  // Only the channel picker uses the configured/hidden filters below.
  // `getAllowedSocialsIntegrations` is deliberately left unfiltered so existing
  // channels keep posting and refreshing even if their credentials go missing.
